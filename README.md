...
|---------------------------------------| --- |---------------------------------------------------------|
| [`llama-cpp`](./homelab-ai/README.md) | `llama.cpp` model router exposed through Traefik as an OpenAI-compatible API | Follow the [`llama-cpp` README](./homelab-ai/README.md) |
